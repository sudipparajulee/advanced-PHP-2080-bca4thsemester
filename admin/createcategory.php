<?php include 'includes/header.php'; ?>
    ...
    <form action="actioncategory.php" method="POST">
        <input type="number" name="priority" placeholder="Enter Priority" class="border rounded-lg px-3 py-2 w-full mb-4 shadow">
        <input type="text" name="name" placeholder="Enter Category Name" class="border rounded-lg px-3 py-2 w-full mb-4 shadow">
